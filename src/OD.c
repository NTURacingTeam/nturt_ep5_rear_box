...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1007_synchronousWindowLength = 0x00004E20,
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_1020_verifyConfiguration = {
        .dataOrig0 = &OD_EEPROM.x1020_verifyConfiguration_sub0,
        .dataOrig = &OD_EEPROM.x1020_verifyConfiguration[0],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataElementLength = 4,
        .dataElementSizeof = sizeof(int32_t)
    ...
    .o_1029_errorBehavior = {
        .dataOrig0 = &OD_EEPROM.x1029_errorBehavior_sub0,
        .dataOrig = &OD_EEPROM.x1029_errorBehavior[0],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_RW,
        .dataElementLength = 1,
